...
BOOST_PYTHON_MODULE(libcrnn){
	...
	.def("size", &RNN_Wrapper::size)
	.def("input_size", &RNN_Wrapper::input_size)
	.def("hidden_size", &RNN_Wrapper::hidden_size)
	.def("output_size", &RNN_Wrapper::output_size)
	.def("zero_all", &RNN_Wrapper::zero_all)
